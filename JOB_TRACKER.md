...
| **2026-08-03** | **Manpro Technologies (Client: HPE)** | Power BI & Power Platform Developer | Bengaluru (WFO) | Up to ₹20.0 LPA | Power BI, DAX, Power Query M, SQL, Gateways, Power Automate | 🟢 **Applied & Email Sent** | **100% Target Match (Up to ₹20 LPA). End Client: HPE.** Recruiter: Preeti Chavan (`priti.chavan@manprotech.org`). Immediate Joiner (0 Days Notice). |
| **2026-08-03** | **Innova ESI** | Data Management Analyst | Bengaluru (On-site) | Undisclosed (15-18 LPA Target) | Data Quality Management, MDM, Data Governance, Metadata, SQL, Python, Power BI | 🟢 **Applied & LinkedIn Direct** | **95% High Match Target. Immediate Joiner Only.** Recruiter: Swaleha Pathan (1st-degree connection). Focus: Data Quality, Governance Scorecards, MDM, SQL, Power BI. Applied via Easy Apply. |

| **2026-08-03** | **Algoleap Technologies** | Senior Data Engineer | Hyderabad | Undisclosed (15-18 LPA Target) | Snowflake, Medallion Architecture, AI-Augmented (Claude Code/Cursor), SQL, Python, Data Quality | 🟢 **Applied** | **95% High Match. Any Graduate listed.** Focus: Snowflake Medallion, Advanced SQL, AI-assisted pipeline automation (Claude Code/Cursor), Data Quality. Applied via Naukri. |

| **2026-08-03** | **ZettaMine Labs Pvt. Ltd.** | Power BI Developer & Administrator with Python Automation | Bengaluru / PAN India | Undisclosed (15-18 LPA Target) | Power BI Dev & Admin, DAX, Power Query M, Python Automation, SQL, Snowflake | 🟢 **Applied & Email Sent** | **100% Slam Dunk Match.** Direct email sent to Muthyala Aruna (`aruna.m@zettamine.com`) & WhatsApp `6302404863`. Focus: Power BI Dev, DAX, SQL, Workspace Mgmt & Python Automation. Immediate Joiner. |

| **2026-08-01** | **Sunbrilo Technology** | SQL Developer (US Healthcare) | 100% Remote | ₹10 - ₹20 Lacs P.A. | Advanced SQL, CTEs, Window Functions, Stored Procedures, Power BI, Azure SQL | 🟢 **Applied (Fresh)** | **100% Slam Dunk Remote Match.** Posted 3h ago. Fits 10+ Yrs Exp, Advanced SQL, Data Quality & Validation. |

| **2026-08-01** | **Zensar Careers** | Collibra SME / Data Governance Lead | Hyderabad / Remote | ₹15.0L - ₹30.0L P.A. | Data Governance, Power BI, SQL, Data Operations | 🟢 **NVite Received** | **Direct Recruiter NVite (₹15L–₹30L).** 1st-degree LinkedIn connection Bhagavat Prasad Sharma (Power BI Architect @ Zensar) messaged & viewed profile. |
| **2026-08-01** | **PASSIONMOJO-PHRCRM** | Data Analytics Specialist | Bengaluru (On-site) | 14.0 LPA Expected | Power BI, SQL, Python, Data Governance, ETL, Analytics | 🟢 **Applied (Fresh)** | **Strong LinkedIn Match.** Posted 1h ago (<35 applicants). Submitted via Easy Apply with updated master resume. |
...
| **2026-07-31** | **Instatalent Recruit LLP** | Data Architect (Urgently Hiring) | Bengaluru / Hyderabad | 15+ Yrs Exp | Data Architecture, SQL, Snowflake, Cloud Pipelines | 👁️ **Application Viewed** | **Naukri Verified Status.** Director Pankaj Saroj viewed application on 31-Jul-2026. |
| **2026-07-31** | **PwC** | Snowflake Architect | Bengaluru / Hyderabad | 12-16 Yrs Exp | Snowflake Architecture, SQL, Medallion Pipeline, Data Quality | 👁️ **Application Viewed Today** | **Naukri Verified Status.** PwC HR Manager viewed application on 01-Aug-2026. |
...
| **2026-07-29** | **Resource Informatics Group** | Offshore - Remote - Power BI Expert | Remote (Hyderabad) | Undisclosed | Power BI, DAX, SQL, Data Modeling | 🔴 **Rejected** | Automated LinkedIn notification received Aug 1. |
